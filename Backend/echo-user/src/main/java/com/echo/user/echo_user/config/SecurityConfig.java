...
public class SecurityConfig {
    ...
    public SecurityFilterChain getSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        // new session or session id.

        return http.build();
    }

    // UserDetailsService is inbuild Interface that provides the username and
    // password for login
    // InMemoryUserDetailsManager is a class there implements with
    // UserDetailsService
    // using both files we provide the username and password for a login process
    // This method is using for create users and password
    // @Bean
